...
let selectableCharacters = [
    ...
    { name: "Screwllum", img: "placeholder.jpeg", element: "Type_Imaginary-removebg-preview.png", description: "A primary damage dealer, apt at dealing with multiple enemies at once." },
    { name: "Yanqing", img: "placeholder.jpeg", element: "Type_Ice.png", description: "A primary damage dealer that consumes skill points fast to damage one enemy." },
    { name: "Stephen", img: "placeholder.jpeg", element: "Type_Imaginary-removebg-preview.png", description: "A tanky support unit that can shield allies and increase their defenses." },
    { name: "Tribios", img: "placeholder.jpeg", element: "Type_Wind.webp", description: "A team support that lets your entire team deal more damage." },
];
...
const debuffList = [
    ...
    { id: "Wind Shear", name: "Wind Shear", src: "placeholder.jpeg", description: `This unit is taking damage each turn and is targeted for a massive attack!`, duration: 3, effect: (attacker, unit) => { takeDamage(unit, Math.pow(attacker.level, 0.2)) }, applier: "", event: "" },
    { id: "Enraged Sting", name: "Enraged", src: "placeholder.jpeg", description: `This unit is preparing to kamikaze itself!`, duration: 2 },
    { id: "Miasma", name: "Miasma", src: "placeholder.jpeg", description: `Take damage each turn and reduces defense by 20%`, duration: 3, effect: (attacker, unit) => { unit.stats.defreduction += 0.2 }, effectdmg: (attacker, unit) => { takeDamage(unit, Math.pow(attacker.level, 0.1)) }, revert: (attacker, unit) => { unit.stats.defreduction -= 0.2 }, applier: "" },
...
const buffList = [
    ...
    { id: "Swift as the Wind", name: "Swift as the Wind", src: "placeholder.jpeg", description: `Increases Yanqing's speed by 25%`, duration: 3, revert: (attacker, unit, applier) => { unit.stats.speed /= 1.25 }, applier: "", event: "" },
    { id: "Destructive as Lightning", name: "Destructive as Lightning", src: "placeholder.jpeg", description: `Yanqing is ignoring 25% of enemy defenses.`, duration: 1, revert: (attacker, unit, applier) => { unit.defignore /= 1.25 }, applier: "", event: "" },
    { id: "Antiviral Buffer", name: "Antiviral Buffer", src: "placeholder.jpeg", description: `Stephen has increased his defense by 25%`, duration: 1, revert: (attacker, unit) => { unit.stats.def /= 1.25 }, applier: "", event: "" },
    { id: "Shield.exe", name: "Shield.exe", src: "placeholder.jpeg", description: `This unit has increased their defense by 25%`, duration: 2, revert: (attacker, unit) => { unit.stats.def /= 1.25 }, applier: "", event: "" },
    { id: "Gales of Tomorrow", name: "Gales of Tomorrow", src: "placeholder.jpeg", description: `This unit has increased their Attack and Speed by 20%`, duration: 3, revert: (attacker, unit, applier) => { unit.stats.atk /= 1.25, unit.stats.speed /= 1.25 }, applier: "", event: "" },
    { id: "Riding the West Wind", name: "Riding the West Wind", src: "placeholder.jpeg", description: `This unit has increased their damage dealt by 50%`, duration: 3, revert: (attacker, unit, applier) => { unit.stats.damageBonus /= 1.5 }, applier: "", event: "" },
];
...
async function start() {
    ...
    enemyList.length = 0;
    generateEnemies(difficultyLevel, newEnemies);
    setBackground();
